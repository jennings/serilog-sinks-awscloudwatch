...
namespace Serilog.Sinks.AwsCloudWatch
{
    ...
    public class CloudWatchLogSink : PeriodicBatchingSink
    {
        ...
        private readonly ITextFormatter renderer;
        ...
        public CloudWatchLogSink(IAmazonCloudWatchLogs cloudWatchClient, CloudWatchSinkOptions options): base(options.BatchSizeLimit, options.Period)
        {
            ...
            this.renderer = options.TextFormatter ?? new MessageTemplateTextFormatter("{Message:lj}", null);
        }
                        ...
                        new Queue<InputLogEvent>(events
                            ...
                            .Select( // transform
                                @event =>
                                {
                                    ...
                                    {
                                        renderer.Format(@event, stringWriter);
